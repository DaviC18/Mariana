...
CREATE TYPE "lead_status" AS ENUM('new', 'qualifying', 'qualified', 'scheduled', 'handed_off');--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_leadId_leads_id_fkey" FOREIGN KEY ("leadId") REFERENCES "leads"("id") ON DELETE CASCADE;--> statement-breakpoint
